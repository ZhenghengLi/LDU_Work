...
gbaixian,
gshoulifenxi,
If[t>=t3,{Red,Line[{{-6,yball2,0.01},{6,yball2,0.01}}]}]
...
"\n",
StringForm["\:6062\:590d\:7cfb\:6570e\:4e3a\:ff1a ``",        NumberForm[e,{3,2}]     ],
StringForm["\:56fa\:5b9a\:80fd\:91cf\:635f\:5931\:4e3a\:ff1a `` J",        ScientificForm[\[CapitalDelta]E0,3]       ]
}]]]
