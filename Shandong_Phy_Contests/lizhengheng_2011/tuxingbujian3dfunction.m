...
gbapan:={Green,EdgeForm[],GrayLevel[0.1],Specularity[1,10],Cuboid[{-6,-32.5,-0.5},{6,-2.5,0}]};


gzhuzuo:={EdgeForm[],RGBColor[0,0,0.1],Specularity[1,10],Cuboid[{-6,-2.5,-0.5},{6,32.5,1.1}],
{
Polygon[{{4.6,32.5,1.1},{3.8,32.5,2.3},{3.8,-2.5,2.3},{4.6,-2.5,1.1}}],
Polygon[{{-4.6,32.5,1.1},{-3.8,32.5,2.3},{-3.8,-2.5,2.3},{-4.6,-2.5,1.1}}],
Polygon[{{4.6,32.5,1.1},{3.8,32.5,2.3},{-3.8,32.5,2.3},{-4.6,32.5,1.1}}],
Polygon[{{4.6,-2.5,1.1},{3.8,-2.5,2.3},{-3.8,-2.5,2.3},{-4.6,-2.5,1.1}}],
Polygon[{{3.8,32.5,2.3},{-3.8,32.5,2.3},{-3.8,-2.5,2.3},{3.8,-2.5,2.3}}],
Polygon[{{1,32.5,2.3},{1.5,32.5,3.5},{1.5,-2.5,3.5},{1,-2.5,2.3}}],
Polygon[{{-1,32.5,2.3},{-1.5,32.5,3.5},{-1.5,-2.5,3.5},{-1,-2.5,2.3}}],
Polygon[{{1,32.5,2.3},{1.5,32.5,3.5},{-1.5,32.5,3.5},{-1,32.5,2.3}}],
Polygon[{{1,-2.51,2.3},{1.5,-2.51,3.5},{-1.5,-2.51,3.5},{-1,-2.51,2.3}}],
Polygon[{{1.5,32.5,3.5},{-1.5,32.5,3.5},{-1.5,-2.5,3.5},{1.5,-2.5,3.5}}]
}};
...
u=Append[u,{White,Polygon[{{4.41,-0.5,1.4},{3.81,-0.5,2.3},{3.81,30.5,2.3},{4.41,30.5,1.4}}]}        ];
u];


gbzqiuzuo:=
{EdgeForm[],GrayLevel[0.1],Specularity[1,10],
Polygon[{{3.8,2.5,2.3},{3.3,2.5,3.05},{3.3,-2.5,3.05},{3.8,-2.5,2.3}}],
Polygon[{{-3.8,2.5,2.3},{-3.8,2.5,3.05},{-3.8,-2.5,3.05},{-3.8,-2.5,2.3}}],
Polygon[{{3.8,2.5,2.3},{3.3,2.5,3.05},{-3.8,2.5,3.05},{-3.8,2.5,2.3}}],
Polygon[{{3.8,-2.5,2.3},{3.3,-2.5,3.05},{-3.8,-2.5,3.05},{-3.8,-2.5,2.3}}],
...
{{EdgeForm[],{GrayLevel[0.1],Specularity[1,10],
Polygon[{{3.8,y+2.5,2.3},{3.3,y+2.5,3.05},{3.3,y-2.5,3.05},{3.8,y-2.5,2.3}}],
Polygon[{{-3.8,y+2.5,2.3},{-3.8,y+2.5,3.05},{-3.8,y-2.5,3.05},{-3.8,y-2.5,2.3}}],
Polygon[{{3.8,y+2.5,2.3},{3.3,y+2.5,3.05},{-3.8,y+2.5,3.05},{-3.8,y+2.5,2.3}}],
Polygon[{{3.8,y-2.5,2.3},{3.3,y-2.5,3.05},{-3.8,y-2.5,3.05},{-3.8,y-2.5,2.3}}],
...
Polygon[{{0.566,y-0.566,z-3.5},{0.566,y+0.566,z-3.5},{0.566,y+0.566,z+21.5},{0.566,y-0.566,z+21.5}}],
Polygon[
...
u=Append[u,{White,EdgeForm[],Specularity[1,10],Polygon[{{0.576,y-0.566,z-0.5},{0.576,y+0.566,z-0.5},{0.576,y+0.566,z+20.5},{0.576,y-0.566,z+20.5}}]}];
u
];
...
Polygon[{{0.6,y-1.375,z-1},{0.6,y-0.566,z-1},{0.6,y-0.566,z+1},{0.6,y-1.375,z+1}}],
Polygon[{{0.6,y+1.375,z-1},{0.6,y+0.566,z-1},{0.6,y+0.566,z+1},{0.6,y+1.375,z+1}}],
{
